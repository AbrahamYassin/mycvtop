...
<head>
  ...
  <style>
    ...
    *{box-sizing:border-box} html,body{margin:0;font-family:Inter,system-ui,-apple-system,Segoe UI,Roboto,Arial,sans-serif;color:var(--text)}
    ...
    .card{width:100%;max-width:520px;background:#fff;border:1px solid var(--border);border-radius:18px;padding:20px;box-shadow:0 20px 60px rgba(0,0,0,.06)}
...
<header class="nav">
  <div class="container nav-inner">
    ...
    <nav><a class="btn" href="register.php">Créer un compte</a></nav>
  </div>
</header>

<main class="wrap">
  <div class="card" role="form" aria-labelledby="loginTitle">
    <h1 id="loginTitle" class="title">Connexion</h1>
    <p class="muted">Ravi de vous revoir 👋</p>
    ...
    <form method="post" novalidate>
      ...
      <div class="row" style="margin-top:10px">
        <span class="muted" style="font-size:13px">Pas de compte ? <a href="register.php">Inscrivez-vous</a></span>
        <button class="btn btn-primary" type="submit">Se connecter</button>
      </div>
    </form>
    <p class="muted" style="margin-top:12px;font-size:12px">En continuant, vous acceptez nos <a href="terms.php">Conditions</a> et notre <a href="privacy.php">Politique de confidentialité</a>.</p>
  </div>
</main>
